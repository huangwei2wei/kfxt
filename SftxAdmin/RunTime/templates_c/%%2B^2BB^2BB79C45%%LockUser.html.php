<?php /* Smarty version 2.6.26, created on 2012-09-13 17:51:03
         compiled from GmSftx/LockUser.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'GmSftx/LockUser.html', 29, false),)), $this); ?>
...
<fieldset>
<legend>封号列表</legend>
<form action="<?php echo $this->_tpl_vars['url']['GmSftx_LockUser_Del']; ?>
...
<table width="100%" border="0" cellpadding="3">
  <tr>
    <td colspan="7">
    	<a href="<?php echo $this->_tpl_vars['url']['GmSftx_LockUser_Add']; ?>
">增加封号用户</a>
    </td>
    </tr>
  <tr>

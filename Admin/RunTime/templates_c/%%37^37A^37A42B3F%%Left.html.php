<?php /* Smarty version 2.6.26, created on 2013-04-02 11:35:41
...
?>
		<li>
			<a href="#">
             <?php if ($this->_tpl_vars['newlang'] == 1): ?>
	                    	<?php if ($this->_tpl_vars['lang'] == 2): ?>
	                    	<?php echo $this->_tpl_vars['list']['name_en']; ?>
...
?>
                    <?php if ($this->_tpl_vars['childList']['value'] == 'Faq_ServiceIndex'): ?>
                    	<li><a href="http://192.168.14.58/kf/index.php" target="_blank">
	                    <?php if ($this->_tpl_vars['newlang'] == 1): ?>
	                    	<?php if ($this->_tpl_vars['lang'] == 2): ?>
	                    	<?php echo $this->_tpl_vars['childList']['name_en']; ?>

	                    	<?php else: ?>
	                    	<?php echo $this->_tpl_vars['childList']['name']; ?>
                    ...
                    <?php else: ?>
                    	<li>
                    	<a href="<?php echo $this->_tpl_vars['childList']['url']; ?>
" class="childMenu" style="" onclick="childMenuClick($(this));" target="main">
                    	 <?php if ($this->_tpl_vars['newlang'] == 1): ?>
	                    	<?php if ($this->_tpl_vars['lang'] == 2): ?>
	                    	<?php echo $this->_tpl_vars['childList']['name_en']; ?>

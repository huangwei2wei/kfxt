<?php /* Smarty version 2.6.26, created on 2013-04-07 15:59:12
         compiled from ActionGame_MasterTools/Silence/SanFen.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'ActionGame_MasterTools/Silence/SanFen.html', 34, false),)), $this); ?>
...
<fieldset>
	<legend>
   		禁言记录 
       	[<a href="<?php echo $this->_tpl_vars['URL_silenceLocalLog']; ?>
">本地日志数据</a>]
    	[<a href="<?php echo $this->_tpl_vars['URL_silenceInGame']; ?>
">游戏内生效数据</a>]
        [<a href="<?php echo $this->_tpl_vars['URL_silenceAdd']; ?>
">增加禁言</a>]
    </legend>
  ...
  <tr>
    ...
    <td>
    	<?php if ($this->_tpl_vars['list']['sub_type'] == 0): ?>
    		禁言至 <?php echo ((is_array($_tmp=@$this->_tpl_vars['list']['endTime'])) ? $this->_run_mod_handler('default', true, $_tmp, '<font color="#999999">无记录</font>') : smarty_modifier_default($_tmp, '<font color="#999999">无记录</font>')); ?>

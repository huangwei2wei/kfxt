<?php /* Smarty version 2.6.26, created on 2013-04-09 10:58:44
         compiled from ActionGame_MasterTools/PlayerLookup/NuFengZhanChui.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'ActionGame_MasterTools/PlayerLookup/NuFengZhanChui.html', 43, false),array('modifier', 'default', 'ActionGame_MasterTools/PlayerLookup/NuFengZhanChui.html', 74, false),)), $this); ?>
...
"/></td>
          ...
          <td align="center"><?php echo $this->_tpl_vars['list']['logOutTime']; ?>
</td>
          <?php $_from = $this->_tpl_vars['column']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):

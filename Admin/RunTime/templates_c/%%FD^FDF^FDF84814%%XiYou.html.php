<?php /* Smarty version 2.6.26, created on 2013-04-11 16:37:11
         compiled from ActionGame_OperatorTools/NoticeEdit/XiYou.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'ActionGame_OperatorTools/NoticeEdit/XiYou.html', 49, false),array('modifier', 'htmlspecialchars', 'ActionGame_OperatorTools/NoticeEdit/XiYou.html', 70, false),array('modifier', 'date_format', 'ActionGame_OperatorTools/NoticeEdit/XiYou.html', 79, false),)), $this); ?>
...
" />
      ...
      <tr>
        ...
        <td>
        	...
        	<textarea name="message" id="message" style="width:600px; height:200px;" onkeyup="view();"><?php echo ((is_array($_tmp=$this->_tpl_vars['info']['message'])) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : smarty_modifier_htmlspecialchars($_tmp)); ?>
      ...
      <tr>
        ...
        <td><input type="text" class="text" name="startTime" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['info']['startTime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
...
',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"/>
      ...
      <tr>
        ...
        <td><input type="text" class="text" name="endTime" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['info']['endTime'])) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d %H:%M:%S') : smarty_modifier_date_format($_tmp, '%Y-%m-%d %H:%M:%S')); ?>
...
" id="interval" /> 秒<div id="intervalTip"></div></td>
      </tr>
      <tr>

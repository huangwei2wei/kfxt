...
class Game_13 extends Game_GameBase{

	//道具申请ID
	const APPLY_TYPE_ITEMCARDAPPLY = 31;

	/**
	 * 初始化
	 */
	public function _init(){
		$this->_gameId = 13;		//游戏Id
		$this->_zp = 'WuDao';	//控制器扩展包
 		$this->_key = 'tencent-gm-1cfcc74b-b0e6-456b-8c8e-a0169394acc7';	//游戏密匙
//		$this->_key = 'ec4826d5-2332-473b-942a-bbfbac834585'; // 本地
	...
	public function getApplyId($mark = ''){
		...
		$applyInfo = array(
			'ItemCardApply'=>self::APPLY_TYPE_ITEMCARDAPPLY,
		);
	...
	public function getIfConf(){
		...
		'MailList'=>array(	//指定玩家获取邮件列表
			...
			'GameLogin'=>array(	//游戏登录
				'action'=>'Wudaopotian',
				'UrlAppend'=>'indexQQ.do',
				'get'=>array('action'=>'login'),
				'body'=>'ActionGame_MasterTools/GameLogin/GongFu.html',
		...
		'ConsumptionDetail'=>array(	//元宝消费消费查询
				'action'=>'GongFu',
				'UrlAppend'=>'log',
				'get'=>array('action'=>'getCostLog'),
		),
			'PointDel'=>array(	//点数扣除
				'action'=>'GongFu',
				'UrlAppend'=>'user',

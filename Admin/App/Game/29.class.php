...
class Game_29 extends Game_GameBase{	
	...
	public function _init(){
		$this->_gameId = 29;		//游戏Id
		$this->_zp = 'XiYou';	//控制器扩展包
		$this->_key = 'e23&^$)(&HJj%dwi^&%$';	//游戏密匙
...
// 		return $this->clientTimeChk('c970ab23-abac-49d0-9976-03d1cd649d47');//特殊处理，周末更新之后换回来
	...
	public function getPostData($data=array(),$serverId=0){
		...
		$postData['domain'] = $this->getServerMarking($serverId);
// 		$gameInfo = $this->getIfConf();
...
// 			'RechargeRecord'=>array('action'=>'Action10',),
			...
			'AddTitleOrGag'=>array(	//添加封号禁言
				'action'=>'XiYou',
				'UrlAppend'=>'player/addPlayerRestict',
				'get'=>array(),
				'post'=>array(),
				'body'=>'',
			...
			'DelTitleOrGag'=>array(	//删除封号禁言
				'action'=>'XiYou',
				'UrlAppend'=>'player/delPlayerRestict',
				'get'=>array(),
				'post'=>array(),
				'body'=>'',
				'notify'=>'Log_TitleOrGag',
			...
			'Notice'=>array(	//公告列表
				'action'=>'XiYou',
				'UrlAppend'=>'announce/getNoticeList',
				'get'=>array(),
				'body'=>'',
			),
			...
			'NoticeEdit'=>array(	//编辑公告
				'action'=>'XiYou',
				'UrlAppend'=>'announce/updateNotice',
				'get'=>array(),
				'body'=>'',
			),
			...
			'Item'=>array(	//道具更新|获得道具列表
				'action'=>'XiYou',
				'UrlAppend'=>'itemCard/getGoodsList',
				'get'=>array(),
				'body'=>'',
			),

...
class ActionGame_MasterTools_PlayerLogType_GongFu extends Action_ActionBase{
...
//		$data = json_decode($data,true);
		...
		if($data['data']['event']){
			foreach($data['data']['event'] as $sub){
				foreach($sub as $event){
					$event = json_decode($event,true);
					$playerLogType[$event['objectId']]['subTypeList'][$event['eventId']] = array(
						'subTypeName'=>$event['typeName'],
						'des'=>$event['typeDescription'],
					);
				}
			}
		}

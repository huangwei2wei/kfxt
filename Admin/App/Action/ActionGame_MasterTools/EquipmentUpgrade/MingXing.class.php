...
class ActionGame_MasterTools_EquipmentUpgrade_MingXing extends Action_ActionBase{
	
	private $_wearType = array('0'=>'未穿戴','1'=>'穿戴中');
	...
	public function getPostData($post=null){
		...
		$postData['sLevel'] = intval($_POST['sLevel']);
		$postData['equipmentName'] = trim($_POST['equipmentName']);
		$postData['equipmentOldLevel'] = intval($_POST['equipmentOldLevel']);
		...
		if($postData['sLevel']<1){
			$this->jump('sLevel Error',-1);
		}
		return $postData;
	}

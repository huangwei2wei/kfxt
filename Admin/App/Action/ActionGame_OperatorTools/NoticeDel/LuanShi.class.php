...
class ActionGame_OperatorTools_NoticeDel_LuanShi extends Action_ActionBase{
	...
	public function _delByid($UrlAppend=NULL,$get=NULL,$post=NULL){
...
// 		print_r($data);exit;
	...
	public function _delByTitle($UrlAppend=NULL,$get=NULL,$post=NULL){
		if(!$_REQUEST['title']){

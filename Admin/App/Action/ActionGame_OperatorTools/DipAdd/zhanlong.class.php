...
class ActionGame_OperatorTools_DipAdd_zhanlong extends Action_ActionBase{
	...
	public function main($UrlAppend=NULL,$get=NULL,$post=NULL){
		...
		if($this->_isPost()){
			if($_GET["world_id"]!=""){
				$sql = "UPDATE t_world_dip SET net_host='".$_POST["net_host"]."',net_port='".$_POST["net_port"]."',dip_text='".$_POST["dip_text"]."' WHERE world_id='".$_GET["world_id"]."'";
			}else{
				$sql = "INSERT INTO t_world_dip(`world_id`,`net_host`,`net_port`,`dip_text`) VALUES('".$_POST["world_id"]."', '".$_POST["net_host"]."', '".$_POST["net_port"]."', '".$_POST["dip_text"]."')";
			}
		...
		if($_GET["world_id"]!=""){
			$a = $this->Select("select * from  t_world_dip where world_id='".$_GET["world_id"]."'",$this->jdbc,$this->user,$this->pwd);

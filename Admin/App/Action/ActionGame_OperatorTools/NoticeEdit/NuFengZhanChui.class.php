...
class ActionGame_OperatorTools_NoticeEdit_NuFengZhanChui  extends Action_ActionBase{
	...
	public function main($UrlAppend=NULL,$get=NULL,$post=NULL){
		...
		if(isset($_GET['id'])){
			...
			$postData = array_merge($postData,array('id'=>intval($_GET['id'])));
			$sendData = array_merge($get,$postData);
			$data = $this->_gameObject->getResult('30515',$sendData);

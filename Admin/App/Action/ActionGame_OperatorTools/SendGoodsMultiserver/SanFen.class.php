...
class ActionGame_OperatorTools_SendGoodsMultiserver_SanFen extends Action_ActionBase{
	private $playerType;
	...
	public function getPostData($post=null){
		...
		$postData = array('isAllUser'=>$isAllUser,'playerType'=>$playerType,'player'=>$player,'title'=>$mailTitle,'content'=>$mailContent,'goods'=>$goods);
	...
	public function main($UrlAppend=null,$get=null,$post=null){
		...
		if($this->_isPost()){
			...
			$getData = $this->_gameObject->getGetData($get);
				...
				if($_POST['isAllUser'] == 1){
					$apply_info .= '<br>是否所有用户：是';
				}else{

 ...
 *
 */
class Model_HaidaoPlayerData extends Model {
	protected $_tableName='haidao_player_data';
...
//			echo $value[0];
//			die();
			if (!array_key_exists($value[0], $serverList)){//如果服务器ID不存在将跳过
			...
			$arr['server_id']=$serverList[$value[0]];	//serverid
	...
	private function _getCheckServerList(){
		$serverList=$this->_getGlobalData('server/server_list_8');
